...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-todo-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-todo-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-todo
# for installing globally
pixi global install django-todo
```
...
It is possible to list all of the versions of `django-todo` available on your platform:
...
```
pixi search django-todo --channel conda-forge
```
